...
The Kubernetes version (1.32.3) is the first part, and the last part (k0s.0) reflects the k0s version, which is built on top of the certain Kubernetes version.
...
```console
# export K0S_VERSION=v1.32.3+k0s.0
