...
require (
	...
	k8s.io/metrics v0.31.10 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.31.10/go.mod#L227-L258
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.31.10
	k8s.io/sample-controller => k8s.io/sample-controller v0.31.10
)
