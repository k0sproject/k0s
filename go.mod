...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.32.11/go.mod#L225-L257
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.32.11
	k8s.io/sample-controller => k8s.io/sample-controller v0.32.11
)
