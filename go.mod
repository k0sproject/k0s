...
require (
	...
	k8s.io/metrics v0.25.11 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.25.11/go.mod#L338-L339
	github.com/docker/distribution => github.com/docker/distribution v2.8.2+incompatible
	github.com/docker/docker => github.com/docker/docker v20.10.17+incompatible

	// https://github.com/kubernetes/kubernetes/blob/v1.25.11/go.mod#L516-L529
