...
require (
	...
	k8s.io/metrics v0.26.12 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.26.12/go.mod#L255-L285
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.26.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.26.12
)
