...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.29.8/go.mod#L251-L282
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.29.8
	k8s.io/sample-controller => k8s.io/sample-controller v0.29.8
)
