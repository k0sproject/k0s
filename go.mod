...
require (
	...
	k8s.io/kube-aggregator v0.30.12
...
require (
	...
	k8s.io/metrics v0.30.12 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.30.12/go.mod#L239-L270
	...
	k8s.io/endpointslice => k8s.io/endpointslice v0.30.12
	k8s.io/kms => k8s.io/kms v0.30.12
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.30.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.30.12
)
