...
require (
	...
	k8s.io/kube-aggregator v0.25.14
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.25.14/go.mod#L338-L339
	github.com/docker/distribution => github.com/docker/distribution v2.8.2+incompatible
	github.com/docker/docker => github.com/docker/docker v20.10.17+incompatible

	// https://github.com/kubernetes/kubernetes/blob/v1.25.14/go.mod#L516-L529
