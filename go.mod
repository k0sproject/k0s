...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.29.5/go.mod#L251-L282
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.29.5
	k8s.io/endpointslice => k8s.io/endpointslice v0.29.5
	k8s.io/kms => k8s.io/kms v0.29.5
