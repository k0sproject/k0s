...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.33.7/go.mod#L227-L259
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.33.7
	k8s.io/sample-controller => k8s.io/sample-controller v0.33.7
)
