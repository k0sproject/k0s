...
require (
	...
	k8s.io/cluster-bootstrap v0.37.0-beta.0
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.37.0-beta.0/go.mod#L229-L263
	...
	k8s.io/cri-client => k8s.io/cri-client v0.37.0-beta.0
	k8s.io/cri-streaming => k8s.io/cri-streaming v0.37.0-beta.0
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.37.0-beta.0
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.37.0-beta.0
	k8s.io/endpointslice => k8s.io/endpointslice v0.37.0-beta.0
	k8s.io/externaljwt => k8s.io/externaljwt v0.37.0-beta.0
	k8s.io/kms => k8s.io/kms v0.37.0-beta.0
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.37.0-beta.0
	k8s.io/sample-controller => k8s.io/sample-controller v0.37.0-beta.0
	k8s.io/streaming => k8s.io/streaming v0.37.0-beta.0
)
