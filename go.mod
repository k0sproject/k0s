...
require (
	...
	k8s.io/metrics v0.28.14 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.28.14/go.mod#L250-L281
	...
	k8s.io/kms => k8s.io/kms v0.28.14
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.28.14
	k8s.io/sample-controller => k8s.io/sample-controller v0.28.14
)
