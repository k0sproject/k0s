...
require (
	...
	k8s.io/kube-aggregator v0.24.13
...
require (
	...
	k8s.io/metrics v0.24.13 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.24.13/go.mod#L342-L343
	github.com/docker/distribution => github.com/docker/distribution v2.8.1+incompatible
	github.com/docker/docker => github.com/docker/docker v20.10.12+incompatible

	// https://github.com/kubernetes/kubernetes/blob/v1.24.13/go.mod#L516-L527
