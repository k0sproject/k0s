...
require (
	...
	k8s.io/metrics v0.30.14 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.30.14/go.mod#L239-L270
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.30.14
	k8s.io/sample-controller => k8s.io/sample-controller v0.30.14
)
