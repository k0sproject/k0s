...
require (
	...
	k8s.io/kube-aggregator v0.31.11
...
require (
	...
	k8s.io/metrics v0.31.11 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.31.11/go.mod#L227-L258
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.31.11
	k8s.io/sample-controller => k8s.io/sample-controller v0.31.11
)
