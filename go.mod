...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.25.12/go.mod#L338-L339
	github.com/docker/distribution => github.com/docker/distribution v2.8.2+incompatible
	github.com/docker/docker => github.com/docker/docker v20.10.17+incompatible

	// https://github.com/kubernetes/kubernetes/blob/v1.25.12/go.mod#L516-L529
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.25.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.25.12
)
