...
require (
	...
	k8s.io/apiextensions-apiserver v0.26.0-rc.1
	...
	k8s.io/kms v0.26.0-rc.1 // indirect
	k8s.io/kube-aggregator v0.26.0-rc.1
	k8s.io/kubectl v0.26.0-rc.1
	k8s.io/kubelet v0.26.0-rc.1
	k8s.io/kubernetes v1.26.0-rc.1
	k8s.io/mount-utils v0.26.0-rc.1
...
require (
	...
	k8s.io/metrics v0.26.0-rc.1 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.26.0-rc.1/go.mod#L337-L338
	...
	k8s.io/kube-controller-manager => k8s.io/kube-controller-manager v0.26.0-rc.1-rc.1-rc.1
