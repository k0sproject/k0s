...
require (
	...
	k8s.io/kube-aggregator v0.31.8
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.31.8/go.mod#L227-L258
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.31.8
	k8s.io/sample-controller => k8s.io/sample-controller v0.31.8
)
