...
require (
	...
	k8s.io/cluster-bootstrap v0.34.12
	k8s.io/component-base v0.34.12
	k8s.io/component-helpers v0.34.12
	k8s.io/cri-api v0.34.12
	k8s.io/kube-aggregator v0.34.12
	k8s.io/kube-proxy v0.34.12
...
require (
	...
	k8s.io/cri-client v0.34.12 // indirect
	k8s.io/klog/v2 v2.130.1 // indirect
	k8s.io/kms v0.34.12 // indirect
	k8s.io/kube-openapi v0.0.0-20250710124328-f3f2b991d03b // indirect
	k8s.io/metrics v0.34.12 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.34.12/go.mod#L227-L259
	...
	k8s.io/externaljwt => k8s.io/externaljwt v0.34.12
	k8s.io/kms => k8s.io/kms v0.34.12
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.34.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.34.12
)
