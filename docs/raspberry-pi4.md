...
```shell
wget -O /tmp/k0s https://github.com/k0sproject/k0s/releases/download/v1.25.5+k0s.0/k0s-v1.25.5+k0s.0-arm64 # replace version number!
...
ubuntu   Ready    control-plane   4m41s   v1.25.5+k0s   10.152.56.54   <none>        Ubuntu 22.04.1 LTS   5.15.0-1013-raspi   containerd://1.6.10
...
NAME          STATUS   ROLES    AGE    VERSION       INTERNAL-IP    EXTERNAL-IP   OS-IMAGE             KERNEL-VERSION      CONTAINER-RUNTIME
node/ubuntu   Ready    <none>   5m1s   v1.25.5+k0s   10.152.56.54   <none>        Ubuntu 22.04.1 LTS   5.15.0-1013-raspi   containerd://1.6.10
