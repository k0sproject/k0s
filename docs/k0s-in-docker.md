...
**Note:** Due to Docker Hub tag validation scheme, we have to use `-` as the k0s version separator instead of the usual `+`. So for example k0s version `v1.24.10+k0s.0` is tagged as `docker.io/k0sproject/k0s:v1.24.10-k0s.0`.
