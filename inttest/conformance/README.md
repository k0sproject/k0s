...
```terraform
k0s_version=v1.24.0-beta.0+k0s.0
k8s_version=v1.24.0-beta.0
...
```shell
TF_VAR_k0s_version=v1.24.0-beta.0+k0s.0 TF_VAR_sonobuoy_version=0.20.0 TF_VAR_k8s_version=v1.24.0-beta.0 terraform apply
```
