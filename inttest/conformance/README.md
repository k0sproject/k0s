...
```terraform
k0s_version=v1.24.11+k0s.0
k8s_version=v1.24.11
...
```shell
TF_VAR_k0s_version=v1.24.11+k0s.0 TF_VAR_sonobuoy_version=0.20.0 TF_VAR_k8s_version=v1.24.11 terraform apply
```
