...
func (s *BasicSuite) TestK0sGetsUp() {
	...
	s.Require().NoError(common.WaitForLease(context.TODO(), kc, "kube-scheduler", "kube-system"))
	s.Require().NoError(common.WaitForLease(context.TODO(), kc, "kube-controller-manager", "kube-system"))
}
