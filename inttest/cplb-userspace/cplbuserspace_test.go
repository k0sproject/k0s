...
{{ else }}
          interfaceType: "mac"
          # 00:00:5E:00:53:00 is a valid mac address but reserved for documentation as per RFC 9542
          interfaceMACAddresses: ["00:00:5E:00:53:00", "{{ .Interface }}" ]
{{ end }}
{{ if .IsIPv6Only }}
    podCIDR: fd00::/108
