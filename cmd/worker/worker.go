...
func NewWorkerCmd() *cobra.Command {
	...
	Note: Token can be passed either as a CLI argument or as a flag`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return c.Start(ctx, nodeName, kubeletExtraArgs, getBootstrapKubeconfig)
		},
	}
...
func (c *Command) Start(ctx context.Context, nodeName apitypes.NodeName, kubeletExtraArgs stringmap.StringMap, getBootstrapKubeconfig clientcmd.KubeconfigGetter) error {
