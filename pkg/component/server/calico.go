            ...
            properties:
              ...
              peerSelector:
                description: Selector for the remote nodes to peer with.  When this
                  ...
                  remote AS number comes from the remote nod ™s NodeBGPSpec.ASNumber,
            ...
            properties:
              ...
              iptablesLockFilePath:
                description: 'IptablesLockFilePath is the location of the iptables
                  ...
                  its standard location (for example if you have mapped it into Feli ™s
              ...
              iptablesPostWriteCheckInterval:
                description: 'IptablesPostWriteCheckInterval is the period after Felix
                  ...
                  This should only occur if another application on the system does ™t
              ...
              metadataPort:
                description: 'MetadataPort is the port of the metadata server. This,
                  combined with global.MetadataAddr (if not ˜Non ™), is used to set
              ...
              egress:
                ...
                items:
                  description: "A Rule encapsulates a set of match criteria and an
                    ...
                    a negated version, prefixed with No . All the match criteria
                      ...
                      properties:
                        ...
                        selector:
                          description: "Selector is an optional field that contains
                            ...
                            that do not have the label my_labe . \n \tNotSelector
                            = \"has(my_label)\" matches packets that are not from
                            Calico-controlled \tendpoints that do have the label my_labe .
                      ...
                      properties:
                        code:
                          description: Match on a specific ICMP code.  If specified,
                            ...
                            limitation imposed by the kerne ™s iptables firewall,
