...
func setAddressLabel(ip net.IP, label uint32) error {
	...
	// https://git.kernel.org/pub/scm/network/iproute2/iproute2.git/tree/ip/ipaddrlabel.c?h=v4.0.0#n176
	if ip.To4() != nil {
...
// https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tree/include/uapi/linux/if_addrlabel.h?h=v4.0#n16
// struct ifaddrlblmsg {
...
// https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tree/include/uapi/linux/if_addrlabel.h?h=v4.0#n24
// enum {
//	IFAL_ADDRESS = 1,
//	IFAL_LABEL = 2,
//	__IFAL_MAX
