...
func TestImagesRepoOverrideInConfiguration(t *testing.T) {
	t.Run("if_has_repository_not_empty_add_prefix_to_all_images", func(t *testing.T) {
		t.Run("default_config", func(t *testing.T) {
			...
			require.Equal(t, "my.repo/twz123/cni-node-1-9-1-bridge-patches:"+constant.KubeRouterCNIInstallerImageVersion, testingConfig.Spec.Images.KubeRouter.CNIInstaller.URI())
			...
			require.Equal(t, "my.repo/twz123/kube-router-v2-10-0-32-g6a5a6bb6-k0s-0:"+constant.KubeRouterCNIImageVersion, testingConfig.Spec.Images.KubeRouter.CNI.URI())
