...
type KubeRouter struct {
	...
	// Patches holds customizations applied to the kube-router resources generated by k0s before they applied.
	// +optional
...
func (k *KubeRouter) Validate(path *field.Path) (errs []error) {
	if k == nil {
		return
	}
