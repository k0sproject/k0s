...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.28.8/config/v1alpha1/types.go#L27-L42
...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.28.8/config/v1alpha1/types.go#L46-L70
