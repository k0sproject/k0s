...
type EnvoyProxy struct {
	...
	// patches holds customizations applied to the Envoy resources generated by k0s before they are applied.
	// +optional
...
type Traefik struct {
	...
	// patches holds customizations applied to the Traefik resources generated by k0s before they are applied.
	// +optional
	Patches Patches `json:"patches,omitempty"`
}
