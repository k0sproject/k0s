...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.27.15/config/v1alpha1/types.go#L26-L41
...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.27.15/config/v1alpha1/types.go#L45-L69
