...
func registerRestarted(logger *logrus.Entry, mgr crman.Manager, eventFilter crpred.Predicate, delegate apdel.ControllerDelegate, statusSocketPath string, isRestartPending IsRestartPendingFunc) error {
